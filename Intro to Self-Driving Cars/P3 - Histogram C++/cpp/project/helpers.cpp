...
/**
    ...
    ===============================================================================
    --> move to the top of the line, because causing error if putting in bottom <--
    ===============================================================================
...
{
	// init
	vector < vector <float> > blurResult;
		...
		for (int j = 0; j < width; j++) 
		{
			...
			for (int dx : {-1, 0, 1}) 
			{
				for (int dy : {-1, 0, 1}) 
				{
					...
					blurResult[new_i][new_j] += mult * grid_val;
				}
			}
		}
